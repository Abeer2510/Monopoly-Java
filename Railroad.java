...
public class Railroad{
    ...
    public Railroad(String name, int[] rents, int location) {
        this.name = name;
        cost = 200;
        rentArray = rents;
        owner = -1;
    ...
    public void handleUnowned(Player player){
        ...
        while (true) {
            String message = "<html><body style='width: 250px; padding: 10px; border: 2px solid #000; background-color: #c9bbc8;'>" +
            ...
            if (choice == 0){
                if(player.money < this.cost){
                    ...
                    player.railroads.add(this.location);
